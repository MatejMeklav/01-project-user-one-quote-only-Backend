...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.findOne = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, data_source_1.AppDataSource.getRepository(user_entity_1.User)];
                    case 1:
    ...
    UsersService.prototype.checkPassword = function (password, repeatedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    UsersService.prototype.create = function (createUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, salt, hash, data, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, data_source_1.AppDataSource.getRepository(user_entity_1.User)];
                    case 1:
    ...
    UsersService.prototype.update = function (updateUserPasswordDto, email) {
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
